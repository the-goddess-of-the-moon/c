  ...
  <div class="row">
    ...
    <div class="col - 8">
      <div class="info">
        ...
        <img src="${user.avatar}" alt="" class="profile" onclick="document.getElementById('avatar - upload').click();">
    ...
    <div class="col - 4">
      <div class="info - box">
        <div class="top">
          <img src="${user.avatar}" alt="" width="80px" height="80px">
          <div>
            <p>常居：${user.address}</p>
            <p>账号：${user.account}</p>
            ...
            <%-- 在显示日期的地方进行修改 --%>
            <%
              Object createTimeObj = user.getCreateTime();
              ...
              if (createTimeObj instanceof LocalDateTime) {
                ...
                createTime = Timestamp.valueOf(localDateTime);
              } else if (createTimeObj instanceof java.util.Date) {
                createTime = (java.util.Date) createTimeObj;
              }
              if (createTime!= null) {
                SimpleDateFormat sdf = new SimpleDateFormat("yyyy - MM - dd");
                String formattedCreateTime = sdf.format(createTime);
            %>
